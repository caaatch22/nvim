  ...
  opts = {
    ...
    highlights = {
      ...
      astrotheme = { -- a table of overrides/changes when applying the astrotheme theme
        ...
        --- Cpp
        ["@variable.cpp"] = { fg = "#e06c75" },
        ["@operator.cpp"] = { fg = "#56b6c2" },
        ["@constant.cpp"] = { fg = "#56b6c2" },
        ["@string.escape.cpp"] = { fg = "#56b6c2" },
        ["@lsp.type.enumMember.cpp"] = { fg = "#56b6c2" },
        ["@type.builtin.cpp"] = { fg = "#c678dd" },
        ["@lsp.type.parameter.cpp"] = { fg = "#e06c75" },
        ["@lsp.typemod.variable.readonly.cpp"] = { fg = "#e06c75" },
        ["@lsp.type.operator.cpp"] = { fg = "#56b6c2" },
        ["@lsp.type.type.cpp"] = { fg = "#e5c06b" },
        ["@lsp.typemod.function.defaultLibrary.cpp"] = { fg = "#61afef" },
        -- Javascript
        ...
        -- ToggleTerm
        ToggleTerm = { fg = "#282c34" , bg = "#282c34" }
